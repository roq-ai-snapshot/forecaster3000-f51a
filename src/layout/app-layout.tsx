...
const LinkItems: Array<LinkItemProps> = [
  ...
  { name: 'key_metric', path: '/key-metrics', entity: 'key_metric', service: AccessServiceEnum.PROJECT, icon: FiHome },
  { name: 'resource', path: '/resources', entity: 'resource', service: AccessServiceEnum.PROJECT, icon: FiHome },
  { name: 'startup', path: '/startups', entity: 'startup', service: AccessServiceEnum.PROJECT, icon: FiHome },
  {
    name: 'user_startup',
    path: '/user-startups',
    entity: 'user_startup',
